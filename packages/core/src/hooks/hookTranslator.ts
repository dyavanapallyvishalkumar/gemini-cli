...
/**
 * Decoupled LLM request format - stable across ZOLT CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across ZOLT CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across ZOLT CLI versions
 */
